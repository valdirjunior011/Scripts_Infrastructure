#############################
# Verificar e Instalar SNMP #
#     alterar Community     #
# Modified: Valdir Junior   #
#############################

$Managers = @("especificar os hosts que podem fazer a coleta das informaçoes")
...
#Configurando as Chaves de Registro do SNMP
